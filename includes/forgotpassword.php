...
echo "<script>alert('Email hoặc số điện thoại của bạn nhập sai');</script>"; 
}
}
...
<div class="modal fade" id="forgotpassword">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Phục hồi mật khẩu</h3>
      </div>
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                <p class="gray_text">Vì lí do bảo mật. Mật khẩu của bạn sẽ được đặt lại.</p>
