			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Thêm xe mới</h2>
...
<label class="col-sm-2 control-label">Hãng<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="leatherseats"> Leather Seats </label>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<button class="btn btn-default" type="reset">Điền lại</button>
