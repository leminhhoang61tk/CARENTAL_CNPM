			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Quản lí trang chủ </h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Chọn nội dung</label>
												<div class="col-sm-8">
                  ...
                  <option value="manage-pages.php?type=aboutus">About Us</option> 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Nội dung đã chọn</label>
												<div class="col-sm-8">
						<?php
