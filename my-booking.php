    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Xe đã đặt </h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Ngày đặt:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Ngày trả:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Bị hủy</a>
            <div class="clearfix"></div>
        </div>
